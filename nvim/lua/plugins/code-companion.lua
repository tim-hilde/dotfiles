					...
					prompts = {
						{
							...
							content = "You are a technical writer creating a GitHub pull request summary.\n"
								...
								.. "Structure the summary with a brief title line (should be conventional commit message), a summary and the impact of the whole PR."
								.. "This is followed by 2-3 paragraphs for each change. Use bullet points."
